import "./_group.css";
import "./QuietMetal.css";

// QuietMetal variant of the GrainDash hero CTA.
export function QuietMetal() {
  return (
    <div className="gd-root qm-root">
      <section className="hero">
        ...
        <div className="wrap hero-inner">
          ...
          <div className="qm-cta-wrapper">
            <a className="qm-btn qm-primary" href="https://graindashapp.net">
              <span className="qm-glow"></span>
              <span className="qm-btn-inner">Get Started →</span>
            </a>
            <a className="qm-btn qm-secondary" href="#download">
              <span className="qm-btn-inner">Download the App</span>
            </a>
          </div>
